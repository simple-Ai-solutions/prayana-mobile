          ...
          {!otpSent ? (
            ...
            <View style={styles.formSection}>
              ...
              <View style={styles.phoneRow}>
                <TouchableOpacity
                  style={[styles.countryCodeButton, { backgroundColor: themeColors.surface, borderColor: themeColors.border }]}
                  onPress={() => setShowCountryPicker(!showCountryPicker)}
                >
                  <Text style={styles.countryFlag}>{selectedCountry.flag}</Text>
                  <Text style={[styles.countryCodeText, { color: themeColors.text }]}>{selectedCountry.code}</Text>
              ...
              {showCountryPicker && (
                <View style={[styles.countryPickerDropdown, { backgroundColor: themeColors.surface, borderColor: themeColors.border }]}>
                  <ScrollView
                  ...
                  >
                    {COUNTRY_CODES.map((country, index) => (
                      ...
                      >
                        ...
                        <Text style={[styles.countryItemName, { color: themeColors.text }]}>{country.name}</Text>
                        <Text style={[styles.countryItemCode, { color: themeColors.textSecondary }]}>{country.code}</Text>
                      </TouchableOpacity>
                    ))}
                  </ScrollView>
                </View>
              ...
              <Text style={[styles.devNote, { color: themeColors.textTertiary }]}>
                OTP will be sent via SMS. If SMS fails, you may receive a voice call.
              </Text>
            </View>
          ) : (
            /* OTP Verification */
            <View style={styles.formSection}>
              ...
              <Text style={[styles.devNote, { color: themeColors.textTertiary }]}>
                Didn't receive an SMS? Try again — if SMS fails, you'll get a voice call reading the code.
              </Text>
            </View>
          )}
        </ScrollView>
