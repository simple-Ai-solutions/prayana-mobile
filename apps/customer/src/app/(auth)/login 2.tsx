...
export default function LoginScreen() {
  ...
  // After a successful sign-in we go to redirectTo if it was passed, else
  // back to the home tab. Used by useRequireAuth() to bring users back to
  // the screen they were trying to act on.
  const postLoginPath: any = redirectTo || '/(tabs)';
      ...
      >
        ...
        >
          ...
          <View style={[styles.card, { backgroundColor: themeColors.card, borderColor: themeColors.border }]}>
            ...
            {/* Title */}
            <Text style={[styles.title, { color: themeColors.text }]}>Welcome to Prayana</Text>
            <Text style={[styles.subtitle, { color: themeColors.textSecondary }]}>Your AI-powered travel companion</Text>
            ...
            <View style={styles.divider}>
              ...
              <Text style={[styles.dividerLabel, { color: themeColors.textTertiary }]}>or sign in with email</Text>
              <View style={[styles.dividerLine, { backgroundColor: themeColors.border }]} />
            </View>

            {/* Email input */}
            <View style={[styles.inputWrap, { backgroundColor: themeColors.inputBackground, borderColor: themeColors.border }]}>
            ...
            <View style={[styles.inputWrap, { backgroundColor: themeColors.inputBackground, borderColor: themeColors.border }]}>
              ...
              <TouchableOpacity onPress={() => setShowPassword((v) => !v)} hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}>
                <Ionicons name={showPassword ? 'eye-off-outline' : 'eye-outline'} size={18} color={themeColors.textTertiary} />
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.signUpRow}>
              <Text style={[styles.signUpLabel, { color: themeColors.textSecondary }]}>Don't have an account? </Text>
            ...
            <View style={styles.divider}>
              <View style={[styles.dividerLine, { backgroundColor: themeColors.border }]} />
              <Text style={[styles.dividerLabel, { color: themeColors.textTertiary }]}>Secure & Private</Text>
              <View style={[styles.dividerLine, { backgroundColor: themeColors.border }]} />
            </View>

            {/* Trust indicators (matching web) */}
            <View style={styles.trustRow}>
              <View style={[styles.trustItem, { backgroundColor: themeColors.inputBackground }]}>
                <Ionicons name="shield-checkmark-outline" size={16} color="#2EC4B6" />
                <Text style={[styles.trustLabel, { color: themeColors.textSecondary }]}>Encrypted</Text>
              </View>
              <View style={[styles.trustItem, { backgroundColor: themeColors.inputBackground }]}>
                <Ionicons name="globe-outline" size={16} color="#d4a017" />
                <Text style={[styles.trustLabel, { color: themeColors.textSecondary }]}>Global Access</Text>
              </View>
              <View style={[styles.trustItem, { backgroundColor: themeColors.inputBackground }]}>
                <Ionicons name="sparkles-outline" size={16} color="#FF6B6B" />
                <Text style={[styles.trustLabel, { color: themeColors.textSecondary }]}>AI Powered</Text>
              </View>
            </View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={[styles.guestBtnText, { color: themeColors.textTertiary }]}>Continue as Guest</Text>
          </TouchableOpacity>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
